    ...
    <>
      ...
      <div className=" flex gap-2 bg-[#202124]">
        <div className=" print:hidden w-2/3 mt-14 px-2">
          <Typography
            sx={{ fontSize: "0.8rem", paddingX: "5px" }}
            gutterBottom
          >
            <NavLink to={"/sale-cashier"}> <HiArrowSmLeft className="mt-1 w-5 h-5"/> </NavLink>
          </Typography>
          <Typography
          ...
          <div className="flex gap-5 my-3 py-5 border-b ">
            <Button variant="outlined" sx={{color:"#f5f5f5",borderColor:"#3F4245"}} startIcon={<BsCashCoin />}>
              Cash
            </Button>
            <Button variant="outlined" sx={{color:"#f5f5f5",borderColor:"#3F4245"}} startIcon={<BsCreditCard />}>
              Credit Card
            </Button>
            <Button variant="outlined" sx={{color:"#f5f5f5",borderColor:"#3F4245"}} startIcon={<BsCreditCard2Back />}>
              Other
            </Button>
          </div>
          <Typography
